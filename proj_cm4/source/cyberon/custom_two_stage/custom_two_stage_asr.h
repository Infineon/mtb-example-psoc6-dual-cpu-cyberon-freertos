 ...
 *
 * Description: This file contains the custom two stage cyberon asr process and
...
#ifndef CUSTOM_TWO_STAGE_ASR_H
#define CUSTOM_TWO_STAGE_ASR_H
 ...
 * @param[in] nNumSample  The number of voice data (a unit is a short, 
 *                        we prefer to add 480 samples per call)
 */
