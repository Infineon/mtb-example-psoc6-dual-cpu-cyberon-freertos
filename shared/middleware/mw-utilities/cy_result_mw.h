...
#define CY_RSLT_MODULE_SYST_COMP_CONTROL_BASE            CY_RSLT_MODULE_MIDDLEWARE_BASE + 19

#define CY_RSLT_MODULE_STAGED_VOICE_CONTROL_BASE         CY_RSLT_MODULE_MIDDLEWARE_BASE + 20

#define CY_RSLT_MODULE_AFE_BASE                          CY_RSLT_MODULE_MIDDLEWARE_BASE + 21

#define CY_RSLT_MODULE_SOD_BASE                          CY_RSLT_MODULE_MIDDLEWARE_BASE + 22
