...
#ifndef __CY_SVC_LP_PROCESS_DATA_H__
#define __CY_SVC_LP_PROCESS_DATA_H__
 ...
 ******************************************************************************/
cy_rslt_t svc_lp_feed_data_to_cbuf_and_notify_task(
        svc_lp_instance_t *lp_instance,
        CY_SVC_DATA_T *input_data);

cy_rslt_t svc_lp_process_data(
        svc_lp_instance_t *lp_instance,
        uint8_t *p_data_buffer_msg);
...
#endif /* __CY_SVC_LP_PROCESS_DATA_H__ */
