...
/**
 * @file staged_voice_control_lp_lpwwd_external.h
 *
 */

#ifndef __CY_SVC_LP_LP_LPWWD_EXTERNAL_H_
#define __CY_SVC_LP_LP_LPWWD_EXTERNAL_H_
...
#endif /* __CY_SVC_LP_LP_LPWWD_EXTERNAL_H_ */
