...
/**
 * @file staged_voice_control_lp_lpwwd.h
 *
 */

#ifndef __CY_SVC_LP_LPWWD_H_
#define __CY_SVC_LP_LPWWD_H_
...
cy_rslt_t svc_lp_lpwwd_reset(svc_lp_instance_t *lp_instance);

cy_rslt_t svc_lp_lpwwd_reset_and_high_components(svc_lp_instance_t *lp_instance);
